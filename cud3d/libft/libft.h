...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/07 14:07:53 by frobain           #+#    #+#             */
/*   Updated: 2024/02/17 13:06:29 by kazuma3845       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_check_next(const char *data, int i, va_list args,
						int *count);
void				ft_putstr(char *str, int *count);
void				ft_puthex_ptr(unsigned long nbr, char letter, int *count);
